 ...
 *       &lt;sequence>
 *         &lt;element name="IATA_EasyPayCriteria" type="{http://www.iata.org/IATA/2015/00/2020.1/IATA_OrderChangeRQ}IATA_EasyPayType" minOccurs="0"/>
 ...
 *         &lt;element name="PaymentCardCriteria" type="{http://www.iata.org/IATA/2015/00/2020.1/IATA_OrderChangeRQ}PaymentCardCriteriaType" minOccurs="0"/>
 *         &lt;element name="PaymentInstrumentOwnershipCode" type="{http://www.iata.org/IATA/2015/00/2020.1/IATA_OrderChangeRQ}OwnershipTypeCodeType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="PrefLevel" type="{http://www.iata.org/IATA/2015/00/2020.1/IATA_OrderChangeRQ}PrefLevelType" minOccurs="0"/>
...
public class PaymentMethodCriteriaType {
    ...
    protected List<OwnershipTypeCodeContentType> paymentInstrumentOwnershipCode;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the paymentInstrumentOwnershipCode property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPaymentInstrumentOwnershipCode().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OwnershipTypeCodeContentType> getPaymentInstrumentOwnershipCode() {
        if (paymentInstrumentOwnershipCode == null) {
            paymentInstrumentOwnershipCode = new ArrayList<OwnershipTypeCodeContentType>();
        }
