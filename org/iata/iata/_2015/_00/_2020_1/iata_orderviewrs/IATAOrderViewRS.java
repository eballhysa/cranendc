 ...
 *       &lt;sequence>
 *         &lt;choice>
 *           &lt;element name="Error" type="{http://www.iata.org/IATA/2015/00/2020.1/IATA_OrderViewRS}ErrorType" maxOccurs="unbounded"/>
 *           &lt;element name="Response" type="{http://www.iata.org/IATA/2015/00/2020.1/IATA_OrderViewRS}ResponseType"/>
 *         &lt;/choice>
 *         &lt;element name="AugmentationPoint" type="{http://www.iata.org/IATA/2015/00/2020.1/IATA_OrderViewRS}AugmentationPoint" minOccurs="0"/>
 *         &lt;element name="MessageDoc" type="{http://www.iata.org/IATA/2015/00/2020.1/IATA_OrderViewRS}MessageDocType" minOccurs="0"/>
 *         &lt;element name="Party" type="{http://www.iata.org/IATA/2015/00/2020.1/IATA_OrderViewRS}PartyType" minOccurs="0"/>
 *         &lt;element name="PayloadAttributes" type="{http://www.iata.org/IATA/2015/00/2020.1/IATA_OrderViewRS}IATA_PayloadStandardAttributesType" minOccurs="0"/>
 *         &lt;element name="PaymentFunctions" type="{http://www.iata.org/IATA/2015/00/2020.1/IATA_OrderViewRS}PaymentFunctionsType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class IATAOrderViewRS {
    ...
    protected List<PaymentFunctionsType> paymentFunctions;
     ...
     * 
     */
    public List<PaymentFunctionsType> getPaymentFunctions() {
        if (paymentFunctions == null) {
            paymentFunctions = new ArrayList<PaymentFunctionsType>();
        }
